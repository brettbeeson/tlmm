...
class Test(unittest.TestCase):
    ...
    def test_vsync_cont(self):
       ...
       # self.assertEqual(228, f, "Got {} frames instead of expected 404".format(f))
        ...
        logging.info("Write {} and read {}. fps_avg={} fps_max={} fps_max*real_total_second/speedup={}"
                     .format(nfiles, f, m.fps_video_avg(speedup=60), m.fps_video_max(speedup=60) / 60, efs))
